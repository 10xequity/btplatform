...
test("the real db/migrations directory parses cleanly and reports 0035", () => {
  ...
  // same commit as the migration, AFTER the ledger row exists in live D1 (v0.58.0 → 0035).
