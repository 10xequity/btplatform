...
test("the real db/migrations directory parses cleanly and reports 0037", () => {
  ...
  // v0.66.0 → 0037, ledger row read back from live D1 2026-08-03 before this line moved).
