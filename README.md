...
**Version:** v0.53.0 · **Date:** 2026-08-02 · **Supersedes:** README @ v0.24.0 (2026-07-26)
...
| `worker/test/` | `node --test` suites. **631 passing at v0.53.0.** | — |
...
Current queue lives in the session handoff (project knowledge). Headline order after v0.53.0:
