...
**Version:** v0.177.0 · **Date:** 2026-08-22 · **Supersedes:** README @ v0.86.0 (2026-08-04)
...
*Counts measured 2026-08-22 at v0.177.0. Re-measure with `preflight.mjs` rather than trusting them.*

| Path | What | Deploy |
|---|---|---|
| `web/` | Static frontend on GitHub Pages. No build step; every page carries a `?v=` cache-bust (**416 across 68 files**). `404.html` and `index.html` ship from the repo **root**, not from here. | Push to `main` |
...
| `worker/test/` | `node --test` suites. **2135 passing across 140 files** (measured, never projected), including a harness that drives the real router against a SQLite copy of the production schema. | — |
