...
**Version:** v0.170.0 · **Date:** 2026-08-18 · **Supersedes:** README @ v0.86.0 (2026-08-04)
...
*Counts measured 2026-08-18 at v0.170.0. Re-measure with `preflight.mjs` rather than trusting them.*
...
| `worker/test/` | `node --test` suites. **2097 passing across 138 files** (measured, never projected), including a harness that drives the real router against a SQLite copy of the production schema. | — |
