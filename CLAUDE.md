...
| Step | File | When |
|---|---|---|
| 1 | `docs/2026-08-03_handoff_v0_66_0.md` | **Every session.** State of record. §0 delivery, §1 measured build state, §3 defects found by measurement, §4 owner answers, §6 next build. |
