...
|---|---|---|---|
| `2026-08-05_handoff_v0_90_0.md` | **v1.13** | 2026-08-05 | **State of record — v0.90.0** (Block D: the KOTC card on the event page + `route_reachability.test.mjs`, whose first run found **25 built-tested-uncalled admin routes**, now a shrink-only baseline in roadmap §-1c D-4). Also records v0.89.0 (B+C+A3). Suite **1287**, files **78**, busters **391/63**, ledger 0042. **All four tester-round root causes fixed**; Block E then §-1b W-A next. B5 still owner-owed. |
