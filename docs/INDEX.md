...
|---|---|---|---|
| `2026-08-05_handoff_v0_89_0.md` | **v1.12** | 2026-08-05 | **State of record — v0.89.0** (Blocks B+C+A3: org honesty, the service-worker purge, the seeded money and KOTC session). Suite **1282**, files **77**, busters **391/63**, ledger 0042. R1 and R3 **fixed**; **Block D (KOTC reachability) is next**. B5 still owner-owed. Supersedes v1.11 (renamed into it): **v0.88.0 state, kept below for one release for the diff-reader.** |
