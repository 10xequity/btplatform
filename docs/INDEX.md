...
|---|---|---|---|
| `2026-08-05_handoff_v0_93_0.md` | **v1.16** | 2026-08-05 | **State of record — v0.93.0** (§-1b W-B: matchup edit-by-entry — first D-4 strike, 25 → 24 — Schedule Editor deep link, print + copy-as-text export). Also records v0.92.0 (W-A) and v0.89.0–v0.91.0 (tester round closed). Suite **1290**, files **79**, busters **393/63**, ledger 0042. Queue: **§-1b W-C (pools from the owner's sizing rules) next**. B5 still owner-owed. |
