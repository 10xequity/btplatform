...
**File:** docs/INDEX.md · **Version:** v1.5 · **Created:** 2026-08-02 · **Updated:** 2026-08-03
...
|---|---|---|---|
| `2026-08-03_handoff_v0_74_0.md` | v1.0 | 2026-08-03 | **State of record.** Delivery (§0), measured build state (§1), ten releases v0.65.0–v0.74.0 (§2), **§3 sixteen defects, one shape, and the finding that three negative controls passed while proving nothing**, owner answers (§4), owed items (§5), next build (§6), next-session prompt (§7). Supersedes and replaces handoff v0.70.0. |
...
| `2026-08-03_spec_kotc_v1_0.md` | v1.0 | 2026-08-03 | Building King/Queen of the Court. Holds the owner’s verbatim format description, the migration 0040 it needs, the order to build the pure functions in, and **five open questions in §6 that must be asked rather than guessed**. |
...
*Changelog: v1.5 (2026-08-03) — handoff row repointed to v0.74.0 (v0.70.0 deleted); KOTC spec registered. v1.4 (2026-08-03) — handoff row repointed to v0.70.0 (v0.68.0 deleted); consolidation log extended through v0.70.0. v1.3 (2026-08-03) — handoff row repointed to v0.68.0 (v0.66.0 deleted); C8 opened and
