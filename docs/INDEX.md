...
|---|---|---|---|
| `2026-08-05_handoff_v0_94_0.md` | **v1.17** | 2026-08-05 | **State of record — v0.94.0** (§-1b W-C: "Plan the day" on Tournament Ops — the pool planner's screen, `pool_split` on `/formats/plan`, D-4 baseline **21**). Also records W-A/W-B and v0.89.0–v0.91.0 (tester round closed). Suite **1290**, files **79**, busters **393/63**, ledger 0042. Queue: **§-1b W-D (seeding suggestions — proposals, never rules) next**. B5 still owner-owed. |
