...
|---|---|---|---|
| `2026-08-05_handoff_v0_91_0.md` | **v1.14** | 2026-08-05 | **State of record — v0.91.0** (Block E complete + D-2; **everything the tester round produced is fixed or recorded**). Also records v0.90.0 (Block D + the 25-route uncalled baseline, §-1c D-4) and v0.89.0 (B+C+A3). Suite **1288**, files **78**, busters **391/63**, ledger 0042. Queue: **§-1b W-A (registration → league wiring) next**. B5 still owner-owed. |
