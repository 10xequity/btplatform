...
|---|---|---|---|
| `2026-08-05_handoff_v0_92_0.md` | **v1.15** | 2026-08-05 | **State of record — v0.92.0** (§-1b W-A: roster routes + shared roster modal, registration ↔ team linked both directions, seeded league rosters). Also records v0.89.0–v0.91.0 (the tester round fully closed). Suite **1290**, files **79**, busters **393/63**, ledger 0042. Queue: **§-1b W-B (league schedule → edit → export → score-by-link) next**. B5 still owner-owed. |
