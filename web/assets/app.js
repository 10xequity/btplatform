...
(function () {
  ...
  async function applyLoginBrand(org) {
    ...
    if (img && brand.logo_url) {
      img.onerror = () => { img.src = "assets/logo-boom-icon-512.png?v=0.211.0"; }; // fail closed on 404
  ...
  function renderLogin(errorMsg) {
    ...
    const brandSlot = `<div class="login-brand"><img id="loginBrandLogo" src="assets/logo-boom-icon-512.png?v=0.211.0" alt="" width="36" height="36" /><span id="loginBrandName">Boomtown Athletics</span></div>`;
    render(`
